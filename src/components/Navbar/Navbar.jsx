  ...
  return (
    <div className='navbar'>
      ...
      <img src={menu_close} onClick={closeMenu} alt="" className="nav-mob-close" />
        ...
        <li><AnchorLink className= 'AnchorLink' offset={50} href='#about'><p onClick={() => setMenu("about me")}>About Me</p></AnchorLink> {menu === "about me" ? <img src={underline} alt='' /> : <></>}</li>
        <li><AnchorLink className= 'AnchorLink' offset={50} href='#services'><p onClick={() => setMenu("services")}>Projects</p></AnchorLink> {menu === "services" ? <img src={underline} alt='' /> : <></>}</li>
